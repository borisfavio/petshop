    ...
    <div class="row">    
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form action="proveedorBuscar.php" method="post" class="form-horizontal">
                   
                    <div class="row">
                        <div class="col-md-10">
                            <input type="text" placeholder="" name="prove" class="form-control" value="">
                        </div>
                        <div class="col-md-2">
                            <button type="submit" class="btn btn-primary" name="buscar">Buscar Proveedor</button>
                        </div>   
                    </div>
                    <br>

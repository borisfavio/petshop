...
echo "<td><a onclick='return confirm(\"Desea Desactivar el Usuario?\")' href='../../controlador/usuarioCtr/operaciones.php?id=".$reg['id_usuario']."&desactivar=".$reg['estado']."' class='btn btn-xs btn-success'>Activar</a></td>";
                ...
                <td><a href="../controlador/clienteBusqueda.php" class="btn btn-primary">Buscar Usuario</a></td>
                <td><a href="../vista/reporte/reporte.php" class="btn btn-primary">Reporte</a></td>
